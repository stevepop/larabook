...
class UserRepositoryTest extends \Codeception\TestCase\Test
{
    ...
    {
        // given - Because we defined user id in the fixtures.xml
        // The TestDummy creates a user for the statuses
    ...
    public function it_follows_another_user()
    {
        ...
        list($john, $susan) = TestDummy::times(2)->create('Larabook\Users\User'); //returns user array that was created
